...
export function LoginPage() {
  ...
  return (
    <div style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: '16px', padding: '24px' }}>
      <h1 style={{ fontSize: '20px', fontWeight: 700, color: '#0f172a', margin: '0 0 16px' }}>Log in</h1>
      <form onSubmit={submit}>
        ...
        <button type="submit" style={{ width: '100%', background: '#61dafb', color: '#0f172a', border: 'none', borderRadius: '8px', padding: '11px', fontSize: '14px', fontWeight: 700, cursor: 'pointer' }}>Sign in</button>
      </form>
    </div>
  );
}