...
export function KanbanColumn(
  { id, label, tasks }: { id: Task['status']; label: string; tasks: Task[] },
) {
  ...
  return (
    <div
      ref={setNodeRef}
      style={{
        flex: 1, minHeight: '160px', borderRadius: '16px', padding: '12px',
    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
        <span style={{ fontSize: '12px', fontWeight: 800, color: '#94a3b8' }}>{label.toUpperCase()}</span>
