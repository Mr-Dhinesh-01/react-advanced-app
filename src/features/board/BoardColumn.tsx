...
function BoardColumn({ title, tasks, onSelect }: BoardColumnProps) {
  ...
  return (
    <div style={{ flex: 1, background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '16px', padding: '12px', minWidth: '0' }}>
      <p style={{ margin: '0 0 10px', fontSize: '13px', fontWeight: 800, color: '#0f172a' }}>{title} ({tasks.length})</p>
